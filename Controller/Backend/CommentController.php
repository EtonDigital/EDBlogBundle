...
class CommentController extends DefaultController
{
    ...
    public function createAction(Request $request, $article)
    {
        ...
        if($this->container->get('security.context')->isGranted('ACCESS_COMMENTS', $user) === false || $this->container->get('security.authorization_checker')->isGranted('CREATE_COMMENT', $user) === false)
